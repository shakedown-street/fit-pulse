"""
Django settings for fit_pulse project.
...
WSGI_APPLICATION = "fit_pulse.wsgi.application"
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PAGINATION_CLASS": "fit_pulse.pagination.StandardPageNumberPagination",
    "PAGE_SIZE": 20,
}
